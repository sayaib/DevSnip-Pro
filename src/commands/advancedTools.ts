...
export function registerAdvancedToolsCommands(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        advancedToolsHubCommand,
        regexBuilderCommand,
        jsonFormatterCommand,
        hashGeneratorCommand,
        base64EncoderCommand,
        urlEncoderCommand,
        timestampConverterCommand,
        jsonToToonCommand
    );
}
...
function getHashGeneratorHtml(): string {
    return `
        <!DOCTYPE html>
        <html>
        <head>
...
function getBase64EncoderHtml(): string {
    return `
        <!DOCTYPE html>
        <html>
        <head>
...
function getUrlEncoderHtml(): string {
    return `
        <!DOCTYPE html>
        <html>
        <head>
...
function getTimestampConverterHtml(): string {
    return `
        <!DOCTYPE html>
        <html>
        <head>
