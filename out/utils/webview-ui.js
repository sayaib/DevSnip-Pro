...
exports.confirmAction = exports.disposeAllToolPanels = exports.openToolPanel = exports.THEME_TOKENS = exports.toastScript = exports.UTILITY_CSS = exports.TOOL_CSS = exports.safePostMessage = exports.embedJson = exports.escapeHtml = exports.getNonce = void 0;
...
exports.toastScript = toastScript;
/**
 ...
 */
function openToolPanel(viewType, title, options, column = vscode.ViewColumn.One) {
    ...
    panel.onDidDispose(() => {
        if (openPanels.get(viewType) === panel)
...
function disposeAllToolPanels() {
    for (const panel of [...openPanels.values()]) {
        panel.dispose();
    }
    openPanels.clear();
}
exports.disposeAllToolPanels = disposeAllToolPanels;
/**
 ...
 */
async function confirmAction(message, confirmLabel, kind = "warning") {
    try {
...
//# sourceMappingURL=webview-ui.js.map