...
const mongoDBCommands_1 = require("./commands/mongoDBCommands");
...
function activate(context) {
    ...
    (0, mongoDBCommands_1.registerMongoDBCommands)(context);
...
class MyTreeDataProvider {
    ...
    getChildren(element) {
        return [
            ...
            this.createCommandButton("Connect to MongoDB", "sayaib.hue-console.connectMongoDB", "database", new vscode.ThemeColor("terminal.ansiBrightGreen")),
