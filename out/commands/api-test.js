...
exports.getWebviewContent = exports.apiTest = exports.ApiTester = exports.shellQuote = void 0;
...
class ApiTester {
    ...
    loadStoredData() {
        try {
            this.cookies = this.context.globalState.get("cookies", {});
            this.history = this.context.globalState.get("apiHistory", []);
            this.environments = this.context.globalState.get("environments", []);
            this.activeEnvironmentIndex = this.context.globalState.get("activeEnvironmentIndex", -1);
        }
        catch (error) {
...
function apiTest(context, services) {
    ...
    const disposable = (0, command_registry_1.registerTrackedCommand)("sayaib.hue-console.openGUI", () => {
        ...
        const messageSubscription = panel.webview.onDidReceiveMessage(async (message) => {
            ...
            if (message.command.startsWith("feature:")) {
                await (0, api_client_features_1.handleFeatureMessage)(message, featureContext);
                return;
            }
                        ...
                        if (featureId === "secScan") {
                            try {
                                ...
                                if (targetUrl.startsWith('http://'))
                                    issues.push("Insecure protocol: using HTTP instead of HTTPS");
                            ...
                            try {
                                ...
                                const promises = Array.from({ length: batchSize }).map(() => {
                                    const t0 = Date.now();
                                    return (0, axios_1.default)({ method: targetMethod, url: targetUrl, validateStatus: () => true, timeout: 10000 })
 ...
 */
function getWebviewContent(history, allowWebSockets) {
