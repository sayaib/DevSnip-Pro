...
function registerBigDataToolsCommands(context) {
    ...
    context.subscriptions.push(hubCmd, schemaViewerCmd, sparkSqlFormatterCmd, dataQualityCheckerCmd, schemaDiffCmd, partitionCalcCmd);
}
exports.registerBigDataToolsCommands = registerBigDataToolsCommands;
/* ================================================================
   HUB
   ================================================================ */
function getBigDataHubHtml(nonce) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
/* ================================================================
   1. SCHEMA VIEWER
   ================================================================ */
function getSchemaViewerHtml(nonce) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
/* ================================================================
   ...
   ================================================================ */
function getSparkSqlFormatterHtml(nonce) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
/* ================================================================
   ...
   ================================================================ */
function getDataQualityCheckerHtml(nonce) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
/* ================================================================
   4. SCHEMA DIFF TOOL
   ================================================================ */
function getSchemaDiffHtml(nonce) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
/* ================================================================
   ...
   ================================================================ */
function getPartitionCalcHtml(nonce) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
//# sourceMappingURL=bigDataTools.js.map